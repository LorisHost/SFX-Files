...
SubmitButton.MouseButton1Click:Connect(function()
    ...
    if KeySystem == "408193719401037819838139_SORTEXkey" then   
screenGui:Destroy()

--Your Script
  loadstring(game:HttpGet("https://raw.githubusercontent.com/LorisHost/lzosiexw/refs/heads/main/Protected_5058604860726879.txt",true))()
  end
end)

GetKeyButton.MouseButton1Click:Connect(function()
 setclipboard("https://link-center.net/1234962/filesortex") 
end) 
